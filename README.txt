...
* **VPN Hosting (v0.5.4):** All three P2P VPNs (Radmin VPN, Hamachi, ZeroTier) are supported connection methods that work even behind CGNAT. The live screen shows a `Friends (VPN <name>)` line for each running VPN, and `CONNECTING.txt` documents them too.
